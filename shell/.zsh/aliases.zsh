...
run_hledger_in_docker="docker run --rm --user $(id -u):$(id -g) -v $HOME/.ledger:/full-fledged-hledger:z"
...
alias buildledger="$run_hledger_in_docker $hledger_image ./export.sh"
